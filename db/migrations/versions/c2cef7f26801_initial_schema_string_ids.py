...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "currency", sa.Enum("EUR", "USD", "GBP", "CHF", "CAD", name="currency"), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum("DRAFT", "SENT", "ACCEPTED", "REJECTED", name="quotestatus"),
            nullable=False,
        ),
        sa.Column("subtotal", sa.Numeric(precision=12, scale=2), nullable=False),
        sa.Column(
            "discount_type", sa.Enum("PERCENTAGE", "FIXED", name="discounttype"), nullable=True
        ),
